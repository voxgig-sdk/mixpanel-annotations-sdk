...
class ListAnnotationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ListAnnotationEntity(self._client, opts)
    ...
    def data_get(self) -> ListAnnotation:
    ...
    def match_get(self) -> ListAnnotation:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ListAnnotation]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ListAnnotation().list() works with no args.
        if reqmatch is None:
            reqmatch = {}

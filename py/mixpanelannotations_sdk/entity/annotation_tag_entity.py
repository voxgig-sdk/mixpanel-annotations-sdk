...
class AnnotationTagEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AnnotationTagEntity(self._client, opts)
    ...
    def data_get(self) -> AnnotationTag:
    ...
    def match_get(self) -> AnnotationTag:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[AnnotationTag]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.AnnotationTag().list() works with no args.
        if reqmatch is None:
            reqmatch = {}

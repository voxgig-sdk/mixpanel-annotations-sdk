...
from mixpanelannotations_sdk.core.spec import MixpanelAnnotationsSpec
from mixpanelannotations_sdk.core import helpers

# Load utility registration (populates Utility._registrar)
from mixpanelannotations_sdk.utility import register

# Load features
from mixpanelannotations_sdk.feature.base_feature import MixpanelAnnotationsBaseFeature
from mixpanelannotations_sdk.features import _has_feature, _make_feature
...
class MixpanelAnnotationsSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = MixpanelAnnotationsUtility()
    ...
    def get_utility(self):
        return MixpanelAnnotationsUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("MixpanelAnnotationsSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Annotation(self, data=None) -> "AnnotationEntity":
        ...
        from mixpanelannotations_sdk.entity.annotation_entity import AnnotationEntity
        return AnnotationEntity(self, data)


    def AnnotationTag(self, data=None) -> "AnnotationTagEntity":
        """Entity factory: client.AnnotationTag().list() / client.AnnotationTag().load({"id": ...})."""
        from mixpanelannotations_sdk.entity.annotation_tag_entity import AnnotationTagEntity
        return AnnotationTagEntity(self, data)
    ...
    def ListAnnotation(self, data=None) -> "ListAnnotationEntity":
        ...
        from mixpanelannotations_sdk.entity.list_annotation_entity import ListAnnotationEntity
    ...
    def Project(self, data=None) -> "ProjectEntity":
        ...
        from mixpanelannotations_sdk.entity.project_entity import ProjectEntity
        return ProjectEntity(self, data)


    def Tag(self, data=None) -> "TagEntity":
        """Entity factory: client.Tag().list() / client.Tag().load({"id": ...})."""
        from mixpanelannotations_sdk.entity.tag_entity import TagEntity
        return TagEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "MixpanelAnnotationsSDK":
        if sdkopts is None:
            sdkopts = {}

# MixpanelAnnotations SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions MixpanelAnnotationsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both MixpanelAnnotationsSDK(...) and MixpanelAnnotationsSDK.test(...) become
#      MixpanelAnnotationsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "mixpanelannotations_sdk"
_SDK_CLASS = "MixpanelAnnotationsSDK"

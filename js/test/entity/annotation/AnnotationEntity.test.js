...
describe('AnnotationEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    assert(annotation_ref01_resdata_up0[annotation_ref01_markdef_up0.name] === annotation_ref01_markdef_up0.value)
    ...
    // REMOVE
    const annotation_ref01_match_rm0 = {}
    annotation_ref01_match_rm0.id = annotation_ref01_data.id

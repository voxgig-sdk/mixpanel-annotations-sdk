...
func registerSDKWords(r *eng.Registry, client *sdk.MixpanelAnnotationsSDK) {
...
func runOp(client *sdk.MixpanelAnnotationsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {

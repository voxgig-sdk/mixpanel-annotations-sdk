...
// MixpanelAnnotations SDK utility: fetcher

class MixpanelAnnotationsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; MixpanelAnnotationsSDK/1.0)';
    ...
    public static function call(MixpanelAnnotationsContext $ctx, string $fullurl, array $fetchdef): array
    {

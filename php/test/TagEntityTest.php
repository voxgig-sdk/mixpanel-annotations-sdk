...
class TagEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set MIXPANEL_ANNOTATIONS_TEST_TAG_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function tag_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("MIXPANEL_ANNOTATIONS_TEST_TAG_ENTID");

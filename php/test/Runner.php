...
class MixpanelAnnotationsTestRunner
{
    ...
    {
        $live = self::getenv('MIXPANEL_ANNOTATIONS_TEST_LIVE');
        $override = self::getenv('MIXPANEL_ANNOTATIONS_TEST_OVERRIDE');
        ...
        $explain = self::getenv('MIXPANEL_ANNOTATIONS_TEST_EXPLAIN');
...
class_alias('MixpanelAnnotationsTestRunner', 'Runner');
class_alias('MixpanelAnnotationsHelpers', 'Helpers');

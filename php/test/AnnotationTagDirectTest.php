...
class AnnotationTagDirectTest extends TestCase
{
    public function test_direct_list_annotation_tag(): void
    {
        $setup = annotation_tag_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-annotation_tag", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function annotation_tag_direct_setup($mockres)
{

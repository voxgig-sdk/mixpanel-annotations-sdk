...
class AnnotationDirectTest extends TestCase
{
    public function test_direct_load_annotation(): void
    {
        $setup = annotation_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-annotation", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function annotation_direct_setup($mockres)
{

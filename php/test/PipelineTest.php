...
// MixpanelAnnotations SDK pipeline test
//
...
{
    private static function utility(): MixpanelAnnotationsUtility
    {
        return new MixpanelAnnotationsUtility();
    }
    ...
    private static function ctx(array $over = []): MixpanelAnnotationsContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new MixpanelAnnotationsContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new MixpanelAnnotationsOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof MixpanelAnnotationsError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new MixpanelAnnotationsOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = MixpanelAnnotationsMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new MixpanelAnnotationsOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = MixpanelAnnotationsMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new MixpanelAnnotationsOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = MixpanelAnnotationsMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MixpanelAnnotationsSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = MixpanelAnnotationsMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new MixpanelAnnotationsResponse([]),
            'result' => new MixpanelAnnotationsResult([]),
        ]);
        [, $err] = MixpanelAnnotationsMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new MixpanelAnnotationsSpec([]),
            'response' => null,
            'result' => new MixpanelAnnotationsResult([]),
        ]);
        [, $err] = MixpanelAnnotationsMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new MixpanelAnnotationsSpec(['step' => 's']),
            'response' => new MixpanelAnnotationsResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new MixpanelAnnotationsResult([]),
        ]);
        [, $err] = MixpanelAnnotationsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new MixpanelAnnotationsSpec(['step' => 's']),
            'response' => new MixpanelAnnotationsResponse(self::resp(200, ['v' => 1])),
            'result' => new MixpanelAnnotationsResult([]),
        ]);
        [, $err] = MixpanelAnnotationsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new MixpanelAnnotationsSpec(['step' => 's']),
            'response' => new MixpanelAnnotationsResponse(self::resp(200, ['v' => 2])),
            'result' => new MixpanelAnnotationsResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        MixpanelAnnotationsMakeResponse::call($ctx);
    ...
    {
        $preset = new MixpanelAnnotationsResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new MixpanelAnnotationsSpec([]),
            'response' => new MixpanelAnnotationsResponse([]),
            'result' => new MixpanelAnnotationsResult([]),
        ...
        [$got, $err] = MixpanelAnnotationsMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new MixpanelAnnotationsResult([])]);
        [, $err] = MixpanelAnnotationsMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new MixpanelAnnotationsSpec([]), 'result' => null]);
        [, $err] = MixpanelAnnotationsMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MixpanelAnnotationsSpec(['step' => 's']),
            'result' => new MixpanelAnnotationsResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new MixpanelAnnotationsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MixpanelAnnotationsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MixpanelAnnotationsSpec(['step' => 's']),
            'result' => new MixpanelAnnotationsResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new MixpanelAnnotationsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MixpanelAnnotationsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MixpanelAnnotationsResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new MixpanelAnnotationsSpec([]),
            'result' => new MixpanelAnnotationsResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = MixpanelAnnotationsMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MixpanelAnnotationsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new MixpanelAnnotationsError('boom', 'boom');
        $utility->fetcher = function (MixpanelAnnotationsContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MixpanelAnnotationsSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = MixpanelAnnotationsMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (MixpanelAnnotationsContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = MixpanelAnnotationsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(MixpanelAnnotationsResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        MixpanelAnnotationsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (MixpanelAnnotationsContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MixpanelAnnotationsSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = MixpanelAnnotationsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new MixpanelAnnotationsResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new MixpanelAnnotationsSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = MixpanelAnnotationsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = MixpanelAnnotationsMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = MixpanelAnnotationsMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new MixpanelAnnotationsResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, MixpanelAnnotationsDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new MixpanelAnnotationsResult(['ok' => false])]);
        $this->expectException(MixpanelAnnotationsError::class);
        MixpanelAnnotationsDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new MixpanelAnnotationsResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', MixpanelAnnotationsMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        MixpanelAnnotationsMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new MixpanelAnnotationsBaseFeature();
        $b = new MixpanelAnnotationsBaseFeature();
        MixpanelAnnotationsFeatureAdd::call($ctx, $a);
        MixpanelAnnotationsFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): MixpanelAnnotationsBaseFeature
    {
        $f = new MixpanelAnnotationsBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        MixpanelAnnotationsFeatureAdd::call($ctx, self::named_feature('a'));
        MixpanelAnnotationsFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        MixpanelAnnotationsFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        MixpanelAnnotationsFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        MixpanelAnnotationsFeatureAdd::call($ctx, $replace);
        ...
        MixpanelAnnotationsFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): MixpanelAnnotationsContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new MixpanelAnnotationsSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MixpanelAnnotationsPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        MixpanelAnnotationsPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new MixpanelAnnotationsResponse(['headers' => null]),
            'result' => new MixpanelAnnotationsResult([]),
        ]);
        MixpanelAnnotationsResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        MixpanelAnnotationsResultBody::call($ctx);

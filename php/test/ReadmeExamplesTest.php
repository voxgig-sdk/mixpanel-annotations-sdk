...
// MixpanelAnnotations SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (MixpanelAnnotationsSDK::test)
...
{
    private const SDK_CLASS = 'MixpanelAnnotationsSDK';
    ...
    private const SDK_BASE = 'mixpanelannotations_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../mixpanelannotations_sdk.php';

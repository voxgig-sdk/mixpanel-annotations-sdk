...
// MixpanelAnnotations SDK paging feature
...
class MixpanelAnnotationsPagingFeature extends MixpanelAnnotationsBaseFeature
{
    ...
    private function _graphql_pre_request(MixpanelAnnotationsContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(MixpanelAnnotationsContext $ctx): bool
    {

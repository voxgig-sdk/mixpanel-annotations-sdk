...
// MixpanelAnnotations SDK timeout feature
...
class MixpanelAnnotationsTimeoutFeature extends MixpanelAnnotationsBaseFeature
{
    ...
    private function _with_timeout(MixpanelAnnotationsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(MixpanelAnnotationsContext $_ctx, float $ms): void
    {
        $client = $this->client;

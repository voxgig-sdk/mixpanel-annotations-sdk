...
// MixpanelAnnotations SDK ratelimit feature
...
class MixpanelAnnotationsRatelimitFeature extends MixpanelAnnotationsBaseFeature
{
    ...
    private function _acquire(MixpanelAnnotationsContext $ctx): void
    {
    ...
    private function _track(MixpanelAnnotationsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;

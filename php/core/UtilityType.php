...
// MixpanelAnnotations SDK utility type

class MixpanelAnnotationsUtility
{
    ...
    public static function copy(MixpanelAnnotationsUtility $src): MixpanelAnnotationsUtility
    {
        $u = new MixpanelAnnotationsUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;

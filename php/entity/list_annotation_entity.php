...
// MixpanelAnnotations SDK ListAnnotation entity
...
class ListAnnotationEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ListAnnotationEntity($this->_client, $opts);
    }

    /**
     * @param ListAnnotation|array $args ListAnnotation data (assoc-array) to store.
     */
    ...
    /**
     * @return ListAnnotation|array The current ListAnnotation data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ListAnnotation fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ListAnnotation fields).
     */
    ...
    /**
     * List ListAnnotation items matching the given filter.
     *
     * @param ListAnnotationListMatch|array|null $reqmatch Match filter (any subset
     *   of ListAnnotation fields) as an assoc-array; ListAnnotationListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ListAnnotation[]|array A list of ListAnnotation items as assoc-arrays at
     *   the SDK boundary; throws MixpanelAnnotationsError on failure (item-5 convention).
     */

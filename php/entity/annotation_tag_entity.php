...
// MixpanelAnnotations SDK AnnotationTag entity
...
class AnnotationTagEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AnnotationTagEntity($this->_client, $opts);
    }

    /**
     * @param AnnotationTag|array $args AnnotationTag data (assoc-array) to store.
     */
    ...
    /**
     * @return AnnotationTag|array The current AnnotationTag data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AnnotationTag fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AnnotationTag fields).
     */
    ...
    /**
     * List AnnotationTag items matching the given filter.
     *
     * @param AnnotationTagListMatch|array|null $reqmatch Match filter (any subset
     *   of AnnotationTag fields) as an assoc-array; AnnotationTagListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AnnotationTag[]|array A list of AnnotationTag items as assoc-arrays at

...
local function make_error_util(ctx, err)
  ...
  local msg = "MixpanelAnnotationsSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = MixpanelAnnotationsError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == MixpanelAnnotationsError then

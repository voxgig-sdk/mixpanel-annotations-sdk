...
local SDK_MODULE = "mixpanel-annotations_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["annotation"] = { ["test01"] = { id = "test01" } }, ["annotation_tag"] = { ["test01"] = { id = "test01" } }, ["list_annotation"] = { ["test01"] = { id = "test01" } }, ["project"] = { ["test01"] = { id = "test01" } }, ["tag"] = { ["test01"] = { id = "test01" } } } }'

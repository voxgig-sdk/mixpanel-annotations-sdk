...
describe("AnnotationDirect", function()
  it("should direct-load-annotation", function()
    local setup = annotation_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-annotation", setup.live and "live" or "unit")

...
describe("ProjectEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set MIXPANEL_ANNOTATIONS_TEST_PROJECT_ENTID JSON to run live")
      return
    end
...
function project_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("MIXPANEL_ANNOTATIONS_TEST_PROJECT_ENTID")
  ...
  local idmap_resolved = helpers.to_map(
    env["MIXPANEL_ANNOTATIONS_TEST_PROJECT_ENTID"])

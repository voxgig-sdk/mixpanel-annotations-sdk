...
function runner.env_override(m)
  local live = runner.getenv("MIXPANEL_ANNOTATIONS_TEST_LIVE")
  local override = runner.getenv("MIXPANEL_ANNOTATIONS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("MIXPANEL_ANNOTATIONS_TEST_EXPLAIN")

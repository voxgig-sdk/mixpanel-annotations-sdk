...
local AnnotationTagEntity = {}
AnnotationTagEntity.__index = AnnotationTagEntity


function AnnotationTagEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AnnotationTagEntity)
  self._name = "annotation_tag"
  self._client = client
...
function AnnotationTagEntity:get_name()
  return self._name
end


function AnnotationTagEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AnnotationTagEntity.new(self._client, opts)
end
...
function AnnotationTagEntity:mark_deleted()
  self._deleted = true
end


function AnnotationTagEntity:deleted()
  return true == self._deleted
end


function AnnotationTagEntity:data_set(args)
  if args ~= nil then
...
function AnnotationTagEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AnnotationTagEntity:match_set(args)
  if args ~= nil then
...
function AnnotationTagEntity:match_get()
...
function AnnotationTagEntity:stream(action, args, callopts)
...
---@param reqmatch AnnotationTagListMatch
---@param ctrl? table
---@return AnnotationTag[]
---@return string? err
function AnnotationTagEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function AnnotationTagEntity:_run_op(ctx, post_done)
  local utility = self._utility

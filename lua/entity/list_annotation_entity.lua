...
local ListAnnotationEntity = {}
ListAnnotationEntity.__index = ListAnnotationEntity


function ListAnnotationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ListAnnotationEntity)
  self._name = "list_annotation"
  self._client = client
...
function ListAnnotationEntity:get_name()
  return self._name
end


function ListAnnotationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ListAnnotationEntity.new(self._client, opts)
end
...
function ListAnnotationEntity:mark_deleted()
  self._deleted = true
end


function ListAnnotationEntity:deleted()
  return true == self._deleted
end


function ListAnnotationEntity:data_set(args)
  if args ~= nil then
...
function ListAnnotationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ListAnnotationEntity:match_set(args)
  if args ~= nil then
...
function ListAnnotationEntity:match_get()
...
function ListAnnotationEntity:stream(action, args, callopts)
...
---@param reqmatch ListAnnotationListMatch
---@param ctrl? table
---@return ListAnnotation[]
---@return string? err
function ListAnnotationEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ListAnnotationEntity:_run_op(ctx, post_done)
  local utility = self._utility

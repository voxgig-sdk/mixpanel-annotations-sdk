...
local AnnotationEntity = {}
AnnotationEntity.__index = AnnotationEntity


function AnnotationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AnnotationEntity)
...
function AnnotationEntity:get_name()
  return self._name
end


function AnnotationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AnnotationEntity.new(self._client, opts)
end
...
function AnnotationEntity:mark_deleted()
  self._deleted = true
end


function AnnotationEntity:deleted()
  return true == self._deleted
end


function AnnotationEntity:data_set(args)
  if args ~= nil then
...
function AnnotationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AnnotationEntity:match_set(args)
  if args ~= nil then
...
function AnnotationEntity:match_get()
...
function AnnotationEntity:stream(action, args, callopts)
...
---@param reqmatch AnnotationLoadMatch
---@param ctrl? table
---@return Annotation
---@return string? err
function AnnotationEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata AnnotationCreateData
---@param ctrl? table
---@return Annotation
---@return string? err
function AnnotationEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata AnnotationUpdateData
---@param ctrl? table
---@return Annotation
---@return string? err
function AnnotationEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch AnnotationRemoveMatch
---@param ctrl? table
---@return Annotation
---@return string? err
function AnnotationEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function AnnotationEntity:_run_op(ctx, post_done)
  local utility = self._utility

...
import type {
  ...
  AnnotationRemoveMatch,
} from '../MixpanelAnnotationsTypes'

// TODO: needs Entity superclass
class AnnotationEntity extends MixpanelAnnotationsEntityBase<Annotation> {

  constructor(client: MixpanelAnnotationsSDK, entopts: any) {
    super(client, entopts)
    this.name = 'annotation'
    this.name_ = 'annotation'
    this.Name = 'Annotation'
  }


  make(this: AnnotationEntity) {
    return new AnnotationEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: AnnotationLoadMatch, ctrl?: Control): Promise<AnnotationEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<Annotation> return stays clean under strict null checks.
  ...
  async create(this: any, reqdata?: AnnotationCreateData, ctrl?: Control): Promise<AnnotationEntity> {
  ...
  async update(this: any, reqdata?: AnnotationUpdateData, ctrl?: Control): Promise<AnnotationEntity> {
  ...
  async remove(
    this: any, reqmatch?: AnnotationRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<AnnotationEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }

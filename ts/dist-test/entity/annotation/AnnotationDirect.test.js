...
(0, node_test_1.describe)('AnnotationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-annotation', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-annotation', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MIXPANEL_ANNOTATIONS_TEST_ANNOTATION_ENTID'];
...
//# sourceMappingURL=AnnotationDirect.test.js.map
...
(0, node_test_1.describe)('AnnotationTagEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'annotation_tag.' + op, live))
                return;
        }
        ...
        let annotation_tag_ref01_data = Object.values(setup.data.existing.annotation_tag)[0];
        // LIST
        const annotation_tag_ref01_ent = client.AnnotationTag();
        const annotation_tag_ref01_match = {};
        annotation_tag_ref01_match['project_id'] = setup.idmap['project01'];
        const annotation_tag_ref01_list = (await annotation_tag_ref01_ent.list(annotation_tag_ref01_match)).map((e) => e.data());
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/annotation_tag/AnnotationTagTestData.json');
    ...
    let idmap = transform(['annotation_tag01', 'annotation_tag02', 'annotation_tag03', 'project01', 'project02', 'project03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=AnnotationTagEntity.test.js.map
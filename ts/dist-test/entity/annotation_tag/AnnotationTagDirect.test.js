...
(0, node_test_1.describe)('AnnotationTagDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-annotation_tag', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-annotation_tag', setup.live))
            return;
...
//# sourceMappingURL=AnnotationTagDirect.test.js.map
...
(0, node_test_1.describe)('ListAnnotationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.MixpanelAnnotationsSDK({
    ...
    (0, node_test_1.test)('direct-list-list_annotation', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-list_annotation', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.MixpanelAnnotationsSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        ...
        let idmap = env['MIXPANEL_ANNOTATIONS_TEST_LIST_ANNOTATION_ENTID'];
    ...
    const client = new __1.MixpanelAnnotationsSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ListAnnotationDirect.test.js.map
...
function envOverride(m) {
    if ('TRUE' === process.env.MIXPANEL_ANNOTATIONS_TEST_LIVE ||
        'TRUE' === process.env.MIXPANEL_ANNOTATIONS_TEST_OVERRIDE) {
    ...
    m.MIXPANEL_ANNOTATIONS_TEST_EXPLAIN = process.env.MIXPANEL_ANNOTATIONS_TEST_EXPLAIN || m.MIXPANEL_ANNOTATIONS_TEST_EXPLAIN;
    return m;
}

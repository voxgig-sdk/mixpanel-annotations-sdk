...
func TestProjectEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set MIXPANEL_ANNOTATIONS_TEST_PROJECT_ENTID JSON to run live")
			return
		}
...
func projectBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("MIXPANEL_ANNOTATIONS_TEST_PROJECT_ENTID")
	...
	idmapResolved := core.ToMapAny(env["MIXPANEL_ANNOTATIONS_TEST_PROJECT_ENTID"])

...
const testSeed = `map[string]any{"entity": map[string]any{"annotation": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "annotation_tag": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "list_annotation": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "project": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "tag": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`

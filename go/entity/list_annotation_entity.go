...
type ListAnnotationEntity struct {
	name    string
	client  *core.MixpanelAnnotationsSDK
...
func NewListAnnotationEntity(client *core.MixpanelAnnotationsSDK, entopts map[string]any) *ListAnnotationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ListAnnotationEntity) GetName() string { return e.name }
...
func (e *ListAnnotationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ListAnnotationEntity) Deleted() bool {
	return e.deleted
}


func (e *ListAnnotationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewListAnnotationEntity(e.client, opts)
}

func (e *ListAnnotationEntity) Data(args ...any) any {
...
func (e *ListAnnotationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ListAnnotation; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ListAnnotationEntity) DataTyped(data ...ListAnnotation) ListAnnotation {
	if len(data) > 0 {
		return typedFrom[ListAnnotation](e.Data(asMap(data[0])))
	}
	return typedFrom[ListAnnotation](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ListAnnotation (all fields
// optional at the wire level).
func (e *ListAnnotationEntity) MatchTyped(match ...ListAnnotation) ListAnnotation {
	if len(match) > 0 {
		return typedFrom[ListAnnotation](e.Match(asMap(match[0])))
	}
	return typedFrom[ListAnnotation](e.Match())
}
...
func (e *ListAnnotationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ListAnnotationEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ListAnnotationEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ListAnnotationListMatch and returns []ListAnnotation. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ListAnnotationEntity) ListTyped(reqmatch ListAnnotationListMatch, ctrl map[string]any) ([]ListAnnotation, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[ListAnnotation](res), nil
}



func (e *ListAnnotationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ListAnnotationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ListAnnotationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ListAnnotationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

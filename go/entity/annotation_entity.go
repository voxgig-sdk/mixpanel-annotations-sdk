...
func NewAnnotationEntity(client *core.MixpanelAnnotationsSDK, entopts map[string]any) *AnnotationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AnnotationEntity) GetName() string { return e.name }
...
func (e *AnnotationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AnnotationEntity) Deleted() bool {
	return e.deleted
}


func (e *AnnotationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAnnotationEntity(e.client, opts)
}

func (e *AnnotationEntity) Data(args ...any) any {
...
func (e *AnnotationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *AnnotationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AnnotationEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *AnnotationEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// AnnotationCreateData and returns an Annotation. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *AnnotationEntity) CreateTyped(reqdata AnnotationCreateData, ctrl map[string]any) (Annotation, error) {
...
func (e *AnnotationEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// AnnotationUpdateData and returns an Annotation. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *AnnotationEntity) UpdateTyped(reqdata AnnotationUpdateData, ctrl map[string]any) (Annotation, error) {
...
func (e *AnnotationEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// AnnotationRemoveMatch and returns an Annotation. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *AnnotationEntity) RemoveTyped(reqmatch AnnotationRemoveMatch, ctrl map[string]any) (Annotation, error) {
...
func (e *AnnotationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

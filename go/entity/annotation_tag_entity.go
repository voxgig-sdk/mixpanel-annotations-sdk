...
type AnnotationTagEntity struct {
	name    string
...
func NewAnnotationTagEntity(client *core.MixpanelAnnotationsSDK, entopts map[string]any) *AnnotationTagEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AnnotationTagEntity) GetName() string { return e.name }
...
func (e *AnnotationTagEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AnnotationTagEntity) Deleted() bool {
	return e.deleted
}


func (e *AnnotationTagEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAnnotationTagEntity(e.client, opts)
}

func (e *AnnotationTagEntity) Data(args ...any) any {
...
func (e *AnnotationTagEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an AnnotationTag; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AnnotationTagEntity) DataTyped(data ...AnnotationTag) AnnotationTag {
	if len(data) > 0 {
		return typedFrom[AnnotationTag](e.Data(asMap(data[0])))
	}
	return typedFrom[AnnotationTag](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through AnnotationTag (all fields
// optional at the wire level).
func (e *AnnotationTagEntity) MatchTyped(match ...AnnotationTag) AnnotationTag {
	if len(match) > 0 {
		return typedFrom[AnnotationTag](e.Match(asMap(match[0])))
	}
	return typedFrom[AnnotationTag](e.Match())
}
...
func (e *AnnotationTagEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AnnotationTagEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *AnnotationTagEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AnnotationTagListMatch and returns []AnnotationTag. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AnnotationTagEntity) ListTyped(reqmatch AnnotationTagListMatch, ctrl map[string]any) ([]AnnotationTag, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[AnnotationTag](res), nil
}



func (e *AnnotationTagEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AnnotationTagEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AnnotationTagEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AnnotationTagEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

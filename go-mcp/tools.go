...
type Args struct {
	Entity string         `json:"entity" jsonschema:"annotation | annotation_tag | list_annotation | project | tag"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.MixpanelAnnotationsSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "mixpanel-annotations_list",
		Description: "List records from MixpanelAnnotations. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "mixpanel-annotations_load",
		Description: "Load a single record from MixpanelAnnotations. " +
...
func runOp(client *sdk.MixpanelAnnotationsSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.MixpanelAnnotationsSDK, name string) (sdk.MixpanelAnnotationsEntity, error) {
	switch strings.ToLower(name) {
	case "annotation":
		return client.Annotation(nil), nil
	case "annotation_tag":
		return client.AnnotationTag(nil), nil

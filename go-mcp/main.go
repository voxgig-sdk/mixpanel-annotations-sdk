// Command MixpanelAnnotations-mcp is an MCP server exposing the MixpanelAnnotations
// SDK as MCP tools.
//
// Two tools are registered:
//
//	MixpanelAnnotations_list  — list records of an entity
//	MixpanelAnnotations_load  — load a single record of an entity
//

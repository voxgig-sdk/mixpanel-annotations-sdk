...
## mixpanel-annotations-openapi.yaml

- **Source:** https://raw.githubusercontent.com/mixpanel/docs/main/openapi/annotations.openapi.yaml
- **Publisher:** Mixpanel (mixpanel/docs, the repository Mixpanel publishes its API docs from)
- **Retrieved:** 2026-09-17
- **Format:** OpenAPI 3.0.2 (YAML)
- **Size:** 15861 bytes
- **Coverage:** 3 paths — the whole Mixpanel Annotations API as published.

...
describe('exists', async () => {
  ...
  //
  // MixpanelAnnotationsSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof MixpanelAnnotationsSDK, true,
      'MixpanelAnnotationsSDK.test() must return a client synchronously')
  })

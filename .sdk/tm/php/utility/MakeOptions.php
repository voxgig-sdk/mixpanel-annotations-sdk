...
// MixpanelAnnotations SDK utility: make_options

class MixpanelAnnotationsMakeOptions
{
    ...
    public static function call(MixpanelAnnotationsContext $ctx): array
    {
        ...
        //
        // `MixpanelAnnotationsSchema::optspec()` is built from the model:
        ...
        $optspec = MixpanelAnnotationsSchema::optspec();

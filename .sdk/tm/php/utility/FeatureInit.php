...
// MixpanelAnnotations SDK utility: feature_init

class MixpanelAnnotationsFeatureInit
{
    public static function call(MixpanelAnnotationsContext $ctx, mixed $f): void
    {
        $fname = $f->get_name();
        $fopts = [];
        if ($ctx->options) {

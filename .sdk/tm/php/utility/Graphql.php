...
// MixpanelAnnotations SDK utility: graphql
//
...
class MixpanelAnnotationsGraphql
{
    ...
    // equivalent.
    public static function body(MixpanelAnnotationsContext $ctx): mixed
    {
    ...
    public static function errors(MixpanelAnnotationsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;

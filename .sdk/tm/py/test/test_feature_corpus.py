# MixpanelAnnotations SDK feature corpus test
#
...
def _client(kase):
    ...
    MixpanelAnnotationsSDK(...), not MixpanelAnnotationsSDK.test(...): the `test` feature is
    ...
    return MixpanelAnnotationsSDK(opts)

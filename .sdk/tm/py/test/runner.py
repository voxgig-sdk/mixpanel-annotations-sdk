...
class MixpanelAnnotationsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = MixpanelAnnotationsTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = MixpanelAnnotationsTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = MixpanelAnnotationsTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")

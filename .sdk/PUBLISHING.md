...
|---|---|---|
| `js/` | @voxgig-sdk/mixpanel-annotations-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/mixpanel-annotations | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/mixpanel-annotations-js \
      --repository voxgig-sdk/mixpanel-annotations-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/mixpanel-annotations-js` shows it, and
`npm trust revoke @voxgig-sdk/mixpanel-annotations-js --id=<id>` removes it.
